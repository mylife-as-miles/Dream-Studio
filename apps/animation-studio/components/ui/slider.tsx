...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex w-full touch-none select-none items-center h-1",
      className
    )}
    {...props}
  >
    <SliderPrimitive.Track className="relative h-1.25 w-full grow overflow-hidden rounded-full bg-secondary">
