...
renderPage("Dream Studio", <DreamStudioLanding />);

function DreamStudioLanding() {
  return (
    <div className="dream-page" id="product">
      ...
      <header className="dream-nav" aria-label="Primary navigation">
        <a className="brand-lockup" href={siteHref("")} aria-label="Dream Studio home">
      ...
      <footer className="dream-footer">
        ...
        <div className="footer-brand">
          <a className="brand-lockup" href={siteHref("")}>
            <DreamMark className="brand-mark" />
            <span>DREAM STUDIO</span>
          </a>
