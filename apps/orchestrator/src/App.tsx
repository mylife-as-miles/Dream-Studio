...
export function App() {
  ...
  const activeEditor = snapshot?.activeView === "blob" || snapshot?.activeView === "animation-studio" || snapshot?.activeView === "character-studio"
  ...
  const handleRestartEditor = async (editorId: "blob" | "animation-studio" | "character-studio") => {
    try {
