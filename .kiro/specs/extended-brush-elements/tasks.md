...
- [x] 2. Create the `@blud/architecture` package with geometry builders and materials
  ...
  - [x] 2.3 Implement `buildSlab` geometry builder
  ...
  - [x] 2.4 Implement `buildCeiling` geometry builder
  ...
  - [x] 2.5 Implement `buildRoof` geometry builder
  ...
  - [x] 2.6 Implement `buildItem` geometry builder
  ...
  - [x] 2.7 Implement `architectureMaterials` default materials
