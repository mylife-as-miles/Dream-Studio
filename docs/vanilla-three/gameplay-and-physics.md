...
`@blud/gameplay-runtime` stays headless. It does not require Three.js.
...
Use `@blud/runtime-physics-rapier` when you want Rapier bindings without baking Rapier into `three-runtime`.
